...
const shopItems = [
  { id: "wallpaper", name: "Duvar Kağıdı", price: 50, image: "./wallpaper.png" },
  { id: "floor", name: "Zemin", price: 50, image: "./floor.png" },
  { id: "window", name: "Pencere", price: 60, image: "./window.png" },
  { id: "bed", name: "Yatak", price: 70, image: "./bed.png" },
  { id: "rug", name: "Halı", price: 40, image: "./rug.png" },
  { id: "plant", name: "Bitki", price: 30, image: "./plant.png" },
  { id: "shelf", name: "Raf", price: 60, image: "./shelf.png" },
  { id: "lamp", name: "Lamba", price: 40, image: "./lamp.png" },
  { id: "toy", name: "Oyuncak", price: 35, image: "./toy.png" }
];
